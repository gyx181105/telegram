# gx 2024.4.22 TIANJIN
# 注：1、此代码在运行时，务必注意openai库为0.28，其余库并无特定版本要求，安装方式：pip install openai==0.28
    # 2、示例中openai.api_key 对应为chatgpt key，bot_token为telegram机器人key
    # 3、示例中NEWS_API_KEY仅为演示，实际可根据真实情况做调整
    # 4、示例中数据库为本地pg数据库，实际使用时需根据自身情况做调整
